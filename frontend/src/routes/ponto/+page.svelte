...
<div class="ponto-container">
	...
	<div class="dados no-print">
		<div class="max-w-2xl mx-auto bg-white p-8 rounded-2xl shadow-xl mt-12 border border-gray-100">
			...
			<form onsubmit={handleImprimir} class="space-y-6">
				<div>
					<label for="nomeAluno" class="block text-sm font-semibold text-gray-700 mb-1"
	...
	<div class="print-only">
		<div id="cabecalho">
			<img src="/brazao_sc_217x233.png" alt="brasao_sc" width="106" height="91" />
			...
			<img src="/logo_cedup_242x242.png" alt="logo_cedup" width="91" height="91" />
		</div>
		...
		<div id="rodape">
			<p class="normal00">
				<span
					>Rua Monsenhor Gercino, 2071 – Bairro Itaum – CEP 89210-155 – Joinville – SC Telefone -
					34812136</span
				><br />
				<span style="text-decoration:underline; color:#1155cc">www.cedup.com.br</span><span>
					- email -
				</span>
				<span style="text-decoration:underline; color:#1155cc">estagiocedupjlle@sed.sc.gov.br</span
				><br />
